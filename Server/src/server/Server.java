...
public class Server extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        disconnect.setText("Disconect this Client");
    ...
    private void cmdStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdStartActionPerformed
        ...
        server.addDisconnectListener(new DisconnectListener(){
            ...
            public void onDisconnect(SocketIOClient sioc){
                server.addListeners("close_your_file");
                System.out.println(sioc);
                removeClient(sioc);
            }
        });
        ...
        server.addEventListener("send_file", DataInitFile.class, new DataListener<DataInitFile>(){
            @Override
            public void onData(SocketIOClient sioc , DataInitFile t, AckRequest ar) throws IOException{
...
//        DefaultTableModel model = (DefaultTableModel) table.getModel();
        ...
        for(int i = 0; i<table.getRowCount(); i++){
            ...
            if(data.getClient() == client){
                try{
                    id = generateFileID();
                File file = new File("E:/HCMUT/MMT/ASS/ASS1/socket_data/"+id+"-" + dataInit.getFileName());
